# Contributing to doc-count-udf

doc-count-udf welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use doc-count-udf, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **doc-count-udf Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/doc-count-udf/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/doc-count-udf.git
$ cd doc-count-udf
$ git remote add upstream git://github.com/grtjn/doc-count-udf.git
```
...
Go to https://github.com/username/doc-count-udf and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/doc-count-udf/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/doc-count-udf/issues
